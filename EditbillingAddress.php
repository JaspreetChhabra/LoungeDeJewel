...
$shipupdate = mysql_query("UPDATE ldj_billing_address SET add_line_1='$add1' , add_line_2='$add2' , city_id= $cityid , States_id=$stateid , country='$country' , zip_code='$zipcode' WHERE billing_add_id='$billid'");
